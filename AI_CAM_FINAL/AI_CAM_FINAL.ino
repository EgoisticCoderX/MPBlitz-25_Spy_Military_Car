// Filename: esp32_detection_cam_firmware.ino
...
// --- WiFi Configuration ---
const char* ssid = "AsishJIOBroadband";      // <-- REPLACE WITH YOUR WIFI NAME
...
void setup() {
    ...
    if(!initCamera()){Serial.println("FATAL: Camera failed! Restarting...");delay(3000);ESP.restart();}
